...
def main():
    ...
    infoedu1 = InfoEdu(id_info=1, titulo="Cómo tomar medicamentos", contenido="Instrucciones para tomar medicamentos correctamente", creditos=1, id_user=1)
    ...
    infoedu1.agregar_info(id_info=1, titulo="Cómo tomar medicamentos", contenido="Instrucciones para tomar medicamentos correctamente", creditos=1, id_user=1)
